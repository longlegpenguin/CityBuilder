...
public class Constants implements java.io.Serializable {
    ...
    public static final int INITIAL_CITY_BALANCE = 100000;
    ...
    public static final int ROAD_ONE_TIME_COST = 200;

    // MAINTENANCE FEES
    public static final int STADIUM_MAINTENANCE_FEE = 100;
    public static final int FOREST_MAINTENANCE_FEE = 100;
    public static final int POLICE_MAINTENANCE_FEE = 100;
    public static final int ROAD_MAINTENANCE_FEE = 100;
    ...
    public static final int GAME_LOST_SATISFACTION = 30;
